...
<!-- begin breadcrumb -->
            <ol class="breadcrumb pull-right">
                <li><a href="<?php echo "http://".$_SERVER['SERVER_NAME'].substr($_SERVER['REQUEST_URI'],0,strlen($_SERVER['REQUEST_URI'])-17);?>">Home</a></li>
                                  ...
                                  <?php 
                                         ...
                                         ?>
                                          <tr>
                                            ...
                                            <td align="right"><?php echo 'Rp. '.number_format($data['gaji_kunjungan']); ?></td>
                                            <td align="right"><?php echo 'Rp. '.number_format($data['gaji_tutorial']); ?></td>
                                            <td align="right"><?php echo 'Rp. '.number_format($data['gaji_lesson']); ?></td>
                                            <td align="right"><?php echo 'Rp. '.number_format($data['gaji_evaluasi']); ?></td>
                                            <td align="right"><?php echo 'Rp. '.number_format($data['gaji_inskeh']); ?></td>
                                            <td align="right"><?php echo 'Rp. '.number_format($data['gaji_insfile']); ?></td>
                                            <td align="right"><?php echo 'Rp. '.number_format($data['gaji_kontribusi']); ?></td>
                                            <td align="right"><?php echo 'Rp. '.number_format($data['gaji_yci']); ?></td>
