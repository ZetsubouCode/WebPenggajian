                            ...
                            <form class="form-horizontal form-bordered" data-parsley-validate="true" name="data_pengguna" action="model/input_pegawai.php" method="POST">
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6">
										<input class="form-control" type="number" name="nip" placeholder="Nama pegawai" maxlength="15" data-parsley-required="true"  />
									</div>
								</div>
                                <div class="form-group">
                            ...
                            <table id="data-table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                     <?php
                                        ...
                                        $sql=mysql_query("SELECT * FROM `t_pegawai` INNER JOIN tb_jabatan ON t_pegawai.id_jabatan=tb_jabatan.kode ORDER BY nama_pegawai ASC");
                                             ...
                                             <tr>
                                               ...
                                               <td><?php echo $data['nama_pegawai']; ?></td>
                                                ...
                                                <td align="center">
                                                    ...
                                                    <a class="btn btn-danger btn-icon btn-sm" data-toggle="modal" data-target="#deletemodal" onclick="setUID('<?php echo $data['nip'];?>')"><i class="fa fa-times"></i></a>
                                                    </td>
                                            </tr>
                                            <?php 
                                        }
