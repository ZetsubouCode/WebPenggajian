...
<!-- begin breadcrumb -->
            ...
            <li><a href="<?php echo "http://".$_SERVER['SERVER_NAME'].substr($_SERVER['REQUEST_URI'],0,strlen($_SERVER['REQUEST_URI'])-18);?>">Home</a></li>
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                        ...
                        <div class="panel-body panel-form">
                            ...
                            <form class="form-horizontal form-bordered" data-parsley-validate="true" name="data_pengguna" action="./model/update_gaji.php" method="POST">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-4 col-sm-4" >Gaji Kunjungan
                                    </label>
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" type="text" name="gaji_kunjungan" readonly id="gaji_kunjunganx" value="<?php echo $data['tunjangan_jabatan'];?>"  data-parsley-required="true" />
                                    </div>
                                </div>
                                 <div class="form-group">
                                    <label class="control-label col-md-4 col-sm-4" >gaji_kunjungan</label>
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" type="number" name="bonus" id="gajikunjunganx" value="<?php echo $data['gaji kunjungan'];?>"  data-parsley-required="true" />
                                    </div>
                                </div>
                                 <div class="form-group">
