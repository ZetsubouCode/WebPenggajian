        ...
        <div class="login login-with-news-feed">
            ...
            <div class="news-feed">
                ...
                <div class="news-caption">
                    <h4 class="caption-title"><i class="fa fa-diamond text-success"></i>PPA AGAPE IO-847 SALATIGA</h4>
                    <p>
                        JL.HASANUDIN NO 3B
                    </p>
                </div>
            ...
            <div class="right-content">
                ...
                <div class="login-header">
                    <div class="brand">
                        <span class="logo"></span> SISTEM INFORMASI AKUNTANSI PENGGAJIAN
                        <small>PPA AGAPE IO-847 SALATIGA</small>
                    </div>
                    <div class="icon">
